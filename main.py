...
if params["save_start"]:
    file = open(params["save_start_file_name"], "w")
...
if params["save_results"]:
    ...
    if params["space"]["optymalization_type"] == "CA":
        file = open(params["save_results_file_name"], "w")
    else:
        file = open(params["save_results_file_name_2"], "w")
    file.write(json.dumps(space.show_space().tolist()))
    file.close()
time3 = time.time()

if params["save_time"]:
    file = open(params["save_time_file_name"], "w")
